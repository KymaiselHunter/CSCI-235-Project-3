...
*/
bool Character::operator==(const Character &pCharacter) const
{
    if(this->getName() == pCharacter.getName() &&
    this->getRace() == pCharacter.getRace() &&
    this->getLevel() == pCharacter.getLevel() &&
    this->isEnemy() == pCharacter.isEnemy())
    {
        return true;
    }
    else return false;
...
void Character::display()// const
{
    ...
    ".\nVitality: " << this->getVitality() << "\nMax Armor: " << this->getArmor();
    if(this->isEnemy()) std::cout << "\nThey are an enemy\n";
    else std::cout << "\nThey are not an enemy\n";

    /*
    displayStr += this->name_();
    displayStr += " is a Level ";
    displayStr +=  this->getLevel();*/
}